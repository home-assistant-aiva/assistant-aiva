...
INSTALLER_PATH = DIST_DIR / "AIVA-Collector-Setup-v0.2.3.exe"
TECH_ZIP_PATH = DIST_DIR / "aiva-collector-windows-exe-v0.2.3.zip"
MANIFEST_PATH = DIST_DIR / "AIVA-Collector-Installer-v0.2.3.manifest.json"
